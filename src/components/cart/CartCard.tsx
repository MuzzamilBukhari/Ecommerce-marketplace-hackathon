...
const CartCard = ({
  ...
  const { handleDelete, updateQuantity } = useCart();
    ...
    <div className="flex gap-3 justify-center items-center py-7 border-b ">
      ...
      <div className="flex justify-center items-start gap-8 sm:gap-40 text-black font-semibold">
        <div className="title lg:mx-10">
          ...
          <div className="text-myGry lg:mb-6 lg:mt-2 text-[14px] tracking-wider flex items-center gap-8">
            <p>Quantity :</p>
            {isCheckout ? (
              <span className="text-myBlk -ml-4">{item.cartQuantity}</span>
            ) : (
