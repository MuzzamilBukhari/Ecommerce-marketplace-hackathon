    ...
    <div className="max-w-[1280px] m-auto min-h-[70vh] md:py-20 sm:py-10 py-6 p-3">
      <div className="w-full md:flex justify-center items-center gap-3">
        <div className="md:w-[35%] w-full sm:p-4 space-y-4 md:py-0 py-8">
          ...
          <p className="text-[#272343] pb-3">Phone: +92 311 1091 341</p>
          ...
          <form action="">
            <div className="w-full grid md:grid-cols-3 grid-cols-2 md:grid-rows-1 grid-rows-2 sm:gap-5 gap-2 rounded-md">
              <input
                type="text"
                name="name"
                className="px-4 py-3 bg-[#F5F5F5] placeholder:text-myGry focus:outline-none col-span-1 rounded-md"
              ...
              <input
                type="phone"
                name="phone"
                className="px-4 py-3 bg-[#F5F5F5] placeholder:text-myGry focus:outline-none md:col-span-1 col-span-2 rounded-md"
                placeholder="Your Phone"
              />
            </div>
            <textarea
              name="message"
              className="sm:my-5 my-2 w-full sm:h-60 h-40 px-4 py-3 bg-[#F5F5F5] placeholder:text-myGry focus:outline-none resize-none rounded-md"
              placeholder="Your Message"
            ></textarea>
            <div className="w-full flex justify-end">
              <button
                type="submit"
                className="px-12 font-medium w-fit bg-[#272343] mr-20 sm:mr-72 text-white py-4 rounded-lg transition-transform hover:scale-105 duration-300"
              >
                Send Message
              </button>
            </div>
